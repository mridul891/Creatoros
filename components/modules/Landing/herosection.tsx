...
export default function HeroSection() {
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <TextBlur
          className="text-center text-4xl font-semibold leading-[1.1] tracking-tight text-foreground sm:text-5xl md:text-6xl"
      ...
      <motion.div variants={itemVariants}>
        <TextBlur
          className="mx-auto max-w-lg pt-2 text-center text-base leading-relaxed text-muted-foreground sm:text-lg"
