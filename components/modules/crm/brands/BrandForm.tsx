...
export function BrandForm({
  ...
  return (
    <CrmFormDialog
      ...
      footer={
        <Button type="submit" form="brand-form" disabled={isSubmitting} className="w-full sm:w-auto">
      ...
      >
        <FieldGroup className="mt-1">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <Field>
                ...
                <Input
                  ...
                  aria-describedby={fieldErrors?.primaryContactName ? contactNameErrorId : undefined}
                />
          ...
          {formError ? (
            ...
            >
              <AlertDescription className="text-[12px] text-[#ff8a7c]">{formError}</AlertDescription>
            </Alert>
          ) : null}
        </FieldGroup>
      </form>
