      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(next) => onChange({ ...values, platform: next })}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(next) =>
              onChange({ ...values, deliverableType: next })
            }
          >
            <SelectTrigger className="h-10 border-border bg-card text-muted-foreground text-xs">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(next) =>
              onChange({
                ...values,
                status: next as DeliverableFormValues["status"],
              })
            }
          >
            <SelectTrigger className="h-10 border-border bg-card text-muted-foreground text-xs">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(next) =>
              onChange({
                ...values,
                approvalStatus: next as DeliverableFormValues["approvalStatus"],
              })
            }
          >
            <SelectTrigger className="h-10 border-border bg-card text-muted-foreground text-xs">
        ...
        <div className="space-y-2">
          <Label
            htmlFor="deliverable-revision-count"
            className="text-[12px] text-muted-foreground"
          >
            Revision Count
          </Label>
          <Input
            ...
            onChange={(event) =>
              onChange({ ...values, revisionCount: event.target.value })
            }
            className="h-10 border-border bg-card text-[13px]"
          />
        ...
        <div className="space-y-2 md:col-span-2">
          <Label
            htmlFor="deliverable-submission-url"
            className="text-[12px] text-muted-foreground"
          >
            Submission URL
          </Label>
          <Input
            ...
            onChange={(event) =>
              onChange({ ...values, submissionUrl: event.target.value })
            }
            placeholder="https://"
            className="h-10 border-border bg-card text-[13px]"
          />
        ...
        <div className="space-y-2 md:col-span-2">
          <Label
            htmlFor="deliverable-published-url"
            className="text-[12px] text-muted-foreground"
          >
            Published URL
          </Label>
          <Input
            ...
            onChange={(event) =>
              onChange({ ...values, publishedUrl: event.target.value })
            }
            placeholder="https://"
            className="h-10 border-border bg-card text-[13px]"
          />
        ...
        <div className="space-y-2 md:col-span-2">
          <Label
            htmlFor="deliverable-brand-notes"
            className="text-[12px] text-muted-foreground"
          >
            Brand Notes
          </Label>
          <Textarea
            ...
            onChange={(event) =>
              onChange({ ...values, brandNotes: event.target.value })
            }
            rows={3}
        ...
        <div className="space-y-2 md:col-span-2">
          <Label
            htmlFor="deliverable-internal-notes"
            className="text-[12px] text-muted-foreground"
          >
            Internal Notes
          </Label>
