...
import { LOGO_ACCENT_CLASS, PRIORITY_DOT_CLASS, STAGES, STAGE_ACTIVE_CLASS, STAGE_CFG, fmt } from "./shared";
...
export function DealCard({ deal, isSelected, onClick, onAdvance, onDragStart, onDragEnd }: DealCardProps) {
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (!isSelected) e.currentTarget.style.borderColor = "rgba(232,64,42,0.3)";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div className="mb-[9px] flex items-start justify-between">
        <div className="flex items-center gap-[9px]">
          <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg font-mono text-[9px] font-extrabold ${logoClass}`}>
            {deal.logo}
          </div>
          <div>
