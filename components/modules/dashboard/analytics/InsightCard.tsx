...
export function InsightCard({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-[rgba(255,255,255,0.07)] bg-[#0D0D0D] px-[22px] py-5 transition-colors duration-200 hover:border-[rgba(232,64,42,0.3)]">
      ...
      <div className="font-mono text-[10px] text-[rgba(255,255,255,0.4)]">Last generated {insight.age}</div>
    </div>
  );
}
