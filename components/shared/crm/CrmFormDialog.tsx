  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="flex max-h-[90vh] w-[calc(100vw-2rem)] flex-col gap-0 overflow-hidden rounded-xl p-0 sm:max-w-[720px]">
        <DialogHeader className="shrink-0 gap-1.5 border-border border-b px-6 py-5">
        ...
        <DialogFooter className="m-0 shrink-0 flex-row justify-end gap-2 rounded-b-xl border-border border-t bg-muted/50 px-6 py-4">
          {footer}
        </DialogFooter>
      </DialogContent>
    </Dialog>
