...
import type { PostFormState } from "@/features/calendar/types/post"
import {
  INPUT_CLASS,
  MONO_FONT,
  type ModalState,
      ...
      <div className="max-h-[90vh] w-[560px] overflow-y-auto rounded-xl bg-card shadow-xl">
        <div className="flex items-center justify-between border-border border-b px-6 py-5">
          <div>
            ...
            <div
              className={`mt-0.5 ${MONO_FONT} text-[11px] text-muted-foreground`}
            >
              June {form.day}, 2026
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4 px-6 py-5">
          <div>
            ...
            />
            {err && (
              <div className="mt-1 font-medium text-[11px] text-destructive">
                {err}
              </div>
            )}
          </div>
            ...
            <div className="flex gap-2">
              {[
                ...
                return (
                  ...
                  >
                    <HugeiconsIcon icon={C.icon} size={12} />
                    {s}
                  </button>
                )
              })}
        ...
        <div className="flex justify-end gap-2.5 border-border border-t px-6 py-4">
