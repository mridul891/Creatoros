      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-[10px]">
          ...
          <div>
            ...
            <div className="mt-[3px] inline-block rounded-[99px] border border-[rgba(232,64,42,0.2)] bg-[rgba(232,64,42,0.1)] px-2 py-[1px] font-mono text-[#E8402A] text-[10px]">
              {insight.tag}
            </div>
          </div>
        </div>
