    ...
    <MarketingPageShell>
      <section className="mx-auto w-full max-w-4xl px-7 py-24 text-white">
        ...
        <div className="space-y-8 text-base leading-7 text-white/75">
          <section>
            <h2 className="mb-2 text-xl font-medium text-white">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-xl font-medium text-white">2. How We Use Information</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-xl font-medium text-white">3. Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-2 text-xl font-medium text-white">4. Security</h2>
            <p>
